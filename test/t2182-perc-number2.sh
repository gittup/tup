...
cat > Tupfile << HERE
: file1 file2 foo/file3 |> cmd %4f |> out1 out2
HERE
parse_fail_msg "Invalid entry 4 for input list"

cat > Tupfile << HERE
: file1 file2 foo/file3 |> cmd %4o |> out1 out2
HERE
parse_fail_msg "Invalid entry 4 for output list"
