...
int tup_option_process_ini(void) {
	...
	if (best_root == -1) {
		fprintf(stderr, "tup warning: Could not find Tupfile.ini defining project root.\n");
		fprintf(stderr, "tup warning: Consider adding a Tupfile.ini to your project root.\n");
		fprintf(stderr, "tup warning: See the man page for more details.\n");
		goto ini_cleanup;
	}
